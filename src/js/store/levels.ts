const levelInfo = [
  ...
  { key: "level-3-floor-2", path: "maps/new-story/level-3-floor-2.json" },
  { key: "level-3-floor-3", path: "maps/new-story/level-3-floor-3.json" },
  { key: "level-4-floor-1", path: "maps/new-story/level-4-floor-1.json" },
  { key: "level-4-floor-2", path: "maps/new-story/level-4-floor-2.json" },
  { key: "level-4-floor-3", path: "maps/new-story/level-4-floor-3.json" },
];
